...
constexpr size_t Nb = 4; // number of columns
constexpr size_t Nk = 4; // key length in 32-bit words
...
const two_d_matrix r_con = {{0x01, 0x00, 0x00, 0x00}, {0x02, 0x00, 0x00, 0x00},
